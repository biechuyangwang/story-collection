...
STORIES = [
    ...
    ("21", "泰山", ["Mount Tai summit", "Taishan Shandong sunrise"]),
    ("22", "杭州西湖", ["West Lake Hangzhou pagoda", "West Lake Hangzhou scenery"]),
    ("23", "青海湖", ["Qinghai Lake", "Qinghai Lake birds island"]),
    ("24", "喀纳斯", ["Kanas Lake Xinjiang", "Kanas river bend"]),
    ("25", "神农架", ["Shennongjia forest", "Shennongjia mountains"]),
    ("26", "峨眉山乐山大佛", ["Mount Emei sea of clouds", "Leshan Giant Buddha"]),
    ("27", "布达拉宫", ["Potala Palace Lhasa", "Potala Palace night"]),
    ...
    ("31", "黄山", ["Huangshan mountain scenery", "Huangshan sea of clouds"]),
    ("32", "梵净山", ["Fanjingshan", "Mount Fanjing summit"]),
    ("33", "三江源", ["Sanjiangyuan nature reserve", "Tibetan antelope Qinghai"]),
    ("34", "额济纳胡杨林", ["Ejina Populus euphratica", "Populus euphratica autumn forest"]),
    ("35", "黄龙五彩池", ["Huanglong Sichuan pools", "Huanglong travertine"]),
    ("36", "泸沽湖", ["Lugu Lake", "Lugu Lake Mosuo"]),
    ("37", "莫高窟", ["Mogao Caves Dunhuang", "Mogao Caves architecture"]),
    ("38", "福建土楼", ["Fujian Tulou", "Tulou building interior"]),
    ("39", "鼓浪屿", ["Gulangyu island Xiamen", "Gulangyu architecture"]),
    ("40", "哈尔滨冰雪", ["Harbin Ice and Snow Sculpture Festival", "Harbin rime ice"]),
    ("41", "四姑娘山", ["Mount Siguniang", "Siguniangshan peak"]),
    ("42", "梅里雪山", ["Meili Snow Mountain", "Kawagarbo Meili"]),
    ("43", "赛里木湖", ["Sayram Lake", "Sayram Lake Xinjiang"]),
    ("44", "扎尕那", ["Zhagana", "Zhagana Gansu village"]),
    ("45", "龙脊梯田", ["Longji rice terraces", "Longsheng rice terraces Guangxi"]),
    ("46", "都江堰", ["Dujiangyan irrigation system", "Dujiangyan weir Li Bing"]),
    ("47", "龙门石窟", ["Longmen Grottoes", "Longmen Grottoes Buddha Luoyang"]),
